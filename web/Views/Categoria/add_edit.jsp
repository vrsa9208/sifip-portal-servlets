    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <form method="post">
                ...
                <input type="hidden" name="activo" value="${requestScope.categoria.activo}" />
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="descripcion" class="form-control" id="descripcion" name="descripcion"
                               value="${requestScope.categoria.descripcion}" placeholder="Descripción">
                    </div>
                </div>
                <button type="submit" class="btn btn-success">Guardar</button>
                <button class="btn btn-link"><a href="<c:url value="Categoria" />">Regresar</a></button>
            </form>
        </div>
    </div>
</div>
